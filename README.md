...
# Setup and Run
   ...
   - Enter an un sorted numbers and click on Sort Numbers button.
...
# Run through SortNumbers-0.0.1-SNAPSHOT.jar
   - Download SortNumbers-0.0.1-SNAPSHOT.jar using git url https://github.com/Ganesamoorthy83/javalab/blob/exercise/Sort/target/SortNumbers-0.0.1-SNAPSHOT.jar 
